...
export default function DashboardPage() {
  ...
  // FIXED: Robust date parser that avoids Timezone issues
  // Converts "YYYY-MM-DD" directly to a Local Date object set to midnight
  ...
  // FIXED: Display date simply by rearranging the string parts
  // This prevents hydration errors by avoiding the Date object for rendering text
      ...
      <main className="p-6 max-w-7xl mx-auto">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {companies.map((company) => {
            // Use optional chaining (?.) in case data is incomplete
